    ...
    <el-main class="main">
      <div class="container">
        ...
        <div class="info-list">
          ...
          <el-card v-else v-for="item in kaogongInfoList" :key="item.id" class="info-card">
            <template #header>
            ...
            <div class="card-content">
              ...
              <div class="meta">
                ...
                <span class="position-type">{{ item.position_type || '全部' }}</span>
                <span class="education">{{ item.education || '不限' }}</span>
...
const categories = ref(['考试公告', '招考公告', '职位表', '报名信息', '笔试信息', '面试信息', '成绩查询', '体检信息', '录用信息'])
